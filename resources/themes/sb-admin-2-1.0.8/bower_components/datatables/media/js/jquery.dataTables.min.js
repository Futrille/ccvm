...
oPaginate:{sFirst:"Primero",sLast:"Último",sNext:"Siguiente",sPrevious:"Anterior"},sEmptyTable:"No hay registros disponibles",sInfo:"Mostrando desde _START_ hasta _END_ de _TOTAL_ registros",sInfoEmpty:"Mostrando 0 to 0 of 0 registros",sInfoFiltered:"(Filtrado de _MAX_ registros totales)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_ registros",sLoadingRecords:"Cargando...",sProcessing:"Procesando...",sSearch:"Buscar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No hay coincidencias en la busqueda"},oSearch:h.extend({},
...
" ui-corner-bl ui-corner-br"});var Mb=m.ext.pager;h.extend(Mb,{simple:function(){return["Anterior","Siguiente"]},full:function(){return["Primero","Anterior","Siguiente","Último"]},numbers:function(a,b){return[Aa(a,b)]},simple_numbers:function(a,b){return["Anterior",Aa(a,b),"Siguiente"]},full_numbers:function(a,b){return["Primero","Anterior",Aa(a,b),"Siguiente","Último"]},_numbers:Aa,numbers_length:7});h.extend(!0,m.ext.renderer,{pageButton:{_:function(a,b,c,d,e,f){var g=a.oClasses,j=a.oLanguage.oPaginate,i=a.oLanguage.oAria.paginate||
{},k,l,m=0,p=function(b,d){var n,r,t,s,v=function(b){Ta(a,b.data.action,true)};n=0;for(r=d.length;n<r;n++){s=d[n];if(h.isArray(s)){t=h("<"+(s.DT_el||"div")+"/>").appendTo(b);p(t,s)}else{k=null;l="";switch(s){case "ellipsis":b.append('<span class="ellipsis">&#x2026;</span>');break;case "Primero":k=j.sFirst;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "Anterior":k=j.sPrevious;l=s+(e>0?"":" "+g.sPageButtonDisabled);break;case "Siguiente":k=j.sNext;l=s+(e<f-1?"":" "+g.sPageButtonDisabled);break;case "Último":k=
